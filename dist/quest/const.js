...
const fewarray = [
  ...
  },
  {
    ...
    name: '精鋭無比「第一戦隊」抜錨準備！',
    detail:
      '主力戦艦編成任務：第一艦隊旗艦に「長門改二」、同二番艦に「陸奥改二」から編成される第一戦隊を配備、精鋭無比の水上打撃艦隊を編成せよ！',
    reward_fuel: 0,
    reward_ammo: 800,
    reward_steel: 800,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '「鬼怒改二」を旗艦として、「北上改二」「大井改二」「球磨改」及び<br>「青葉改」「浦波改」「敷波改」から5隻、計6隻の精鋭「第十六戦隊」を再編成せよ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '新編「第一戦隊」を編成せよ！',
    detail:
      '編成任務：第一艦隊に新改装された長門型戦艦一番艦「長門改二」及び同二番艦「陸奥改」からなる<br>新編第一戦隊を配備せよ！',
    reward_fuel: 0,
    reward_ammo: 880,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '新編「第七戦隊」を編成せよ！',
    detail:
      '編成任務：第一艦隊旗艦に新改装された改鈴谷型「熊野改二」、同二番艦に「鈴谷改二」、<br>僚艦に「最上改」「三隈改」を配した新編第七戦隊を配備せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 700,
  ...
  },
  {
    ...
    detail:
      '編成任務：第一艦隊旗艦及び同二番艦に練度50以上の航空戦艦「伊勢」「日向」を配備、<br>随伴艦に軽巡洋艦1隻、駆逐艦2隻他を伴う精鋭「第四航空戦隊」を再編成せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 400,
  ...
  },
  {
    ...
    detail:
      '編成任務：第一艦隊旗艦に「由良改二」を配備、随伴艦に二駆「村雨」「夕立」「春雨」「五月雨」<br>他1隻の駆逐艦を配備、新編「第四水雷戦隊」を編成せよ！',
    reward_fuel: 400,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '編成任務：「文月改二」「皐月改二」「水無月改」「長月改」の精強駆逐艦4隻の編成による<br>精鋭第二二駆逐隊を再編成せよ！',
    reward_fuel: 220,
    reward_ammo: 0,
    reward_steel: 220,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精強「任務部隊」を編成せよ！',
    detail:
      '編成任務：第一艦隊旗艦に「Saratoga Mk.II」または同「Mod.2」を配備、随伴艦に<br>軽巡洋艦1隻、駆逐艦2隻以上を配した夜間作戦可能な機動部隊を新編せよ！',
    reward_fuel: 0,
    reward_ammo: 300,
    reward_steel: 0,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    detail:
      '精鋭駆逐隊編成任務：「朝潮改二」「大潮改二」「荒潮改二」「満潮改二」の<br>最精鋭朝潮型駆逐艦4隻による新編「第八駆逐隊」の編成を完了せよ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '捷一号作戦準備任務：第一遊撃部隊第三部隊の中核となる第二戦隊の随伴艦を編成する。<br>各艦隊から艦艇を抽出、第三艦隊に「最上」「時雨」「満潮」「朝雲」「山雲」を配備せよ！',
    reward_fuel: 0,
    reward_ammo: 300,
    reward_steel: 300,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「四水戦」抜錨準備！',
    detail:
      '四水戦(4Sd)特別編成：「村雨改二」旗艦と精鋭四水戦「由良改二」「夕立改二」「春雨改」「五月雨改」<br>「秋月改」より3隻、さらに主力艦2隻を配備した、有力な特務艦隊を編成、南方海域出撃に備えよ！',
    reward_fuel: 0,
    reward_ammo: 400,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「第二一駆逐隊」、抜錨準備！',
    detail:
      '精鋭駆逐隊編成任務：捷一号作戦を支援する。同決戦正面の基地航空への資材輸送任務のため、<br>「若葉改」「初春改二」「初霜改二」を含む3～4隻の精鋭「第二一駆逐隊」の編成を完了せよ！',
    reward_fuel: 100,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    name: '改装「第十七駆逐隊」、再編始め！',
    detail:
      '改装駆逐隊編成任務：改装した陽炎型駆逐艦「浦風改」「谷風改」、そして対空戦闘の激化に備え、<br>対空兵装を軸に大幅強化改装した「磯風乙改」「浜風乙改」による「第十七駆逐隊」を再編せよ！',
    reward_fuel: 170,
    reward_ammo: 170,
    reward_steel: 170,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '精鋭駆逐隊編成任務：「霰改二」「霞改二/改二乙」「陽炎改」「不知火改」4隻による精鋭「第十八駆逐隊」を編成せよ！',
    reward_fuel: 180,
    reward_ammo: 0,
    reward_steel: 180,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '最精鋭甲型駆逐艦、集結せよ！',
    detail:
      '甲型駆逐隊編成任務：「陽炎改二」「不知火改二」「黒潮改二」を集中配備、さらに練度70以上の甲型駆逐艦【陽炎型/夕雲型駆逐艦】を3隻集中配備、精鋭艦隊型駆逐隊を編成せよ！',
    reward_fuel: 150,
    reward_ammo: 150,
    reward_steel: 150,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '改装甲型駆逐隊編成任務：対空兵装を軸に大幅強化改装した「磯風乙改」「浜風乙改」、そして対潜兵装を強化改装した「浦風丁改」「谷風丁改」による、精鋭「第十七駆逐隊」を編成せよ！',
    reward_fuel: 170,
    reward_ammo: 170,
    reward_steel: 0,
    reward_bauxite: 170,
  ...
  },
  {
    ...
    name: '精鋭「第十駆逐隊」、抜錨準備！',
    detail:
      '甲型駆逐艦編成任務：夕雲型駆逐艦「夕雲改二」および「巻雲改二」の2隻から成る精鋭第十駆逐隊(2隻編成)を編成せよ！',
    reward_fuel: 200,
    reward_ammo: 0,
    reward_steel: 200,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「羽黒」「神風」、出撃せよ！',
    detail:
      '第五戦隊任務：「羽黒」「神風」を基幹として、他に重巡級1隻駆逐艦2隻、または駆逐艦4隻の艦隊で南西諸島近海、バシー海峡、東部オリョール海に出撃、敵艦隊と交戦、これを撃滅せよ！',
    reward_fuel: 516,
    reward_ammo: 0,
    reward_steel: 1945,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '海上警備任務：軽空母または軽巡級1隻、駆逐艦または海防艦を計3隻以上配備した海上護衛艦隊で、南西諸島沖警備、海上護衛作戦、南1号作戦、南西諸島哨戒を実施、各作戦海域の敵を撃滅せよ！',
    reward_fuel: 400,
    reward_ammo: 400,
    reward_steel: 0,
    reward_bauxite: 400,
  ...
  },
  {
    ...
    detail:
      '第一艦隊第一戦隊、改装主力戦艦「長門改二」及び「陸奥改二」を中核とした水上打撃艦隊を編成、バシー海峡、北方AL海域戦闘哨戒、カレー洋リランカ島沖及び南方海域前面の敵を捕捉撃滅せよ！',
    reward_fuel: 800,
    reward_ammo: 800,
    reward_steel: 800,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「比叡」の出撃',
    detail:
      '「比叡」南方海域出撃任務：高速戦艦「比叡」を旗艦とする有力な戦隊で、南方海域サブ島沖海域及びサーモン海域に出撃。同作戦海域の敵戦隊と交戦、これを撃滅せよ！',
    reward_fuel: 0,
    reward_ammo: 1113,
    reward_steel: 1942,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「第七駆逐隊」、南西諸島を駆ける！',
    detail:
      '「曙」「潮」「漣」「朧」からなる「第七駆逐隊」2隻以上を含む有力な艦隊を編成、南西諸島近海、バシー海峡、東部オリョール海、沖ノ島海域の敵戦力を撃滅、南西諸島海域の制海権を確保せよ！',
    reward_fuel: 700,
    reward_ammo: 700,
    reward_steel: 700,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '軽巡旗艦、駆逐艦または海防艦2隻を含む艦隊を編成、南西諸島沖、製油所地帯沿岸、南西諸島防衛戦、南西諸島近海、バシー海峡を哨戒、敵艦隊を捕捉撃滅、近海の制海権を確立せよ！',
    reward_fuel: 800,
    reward_ammo: 800,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '甲型駆逐艦の戦力整備計画',
    detail:
      '甲型駆逐艦整備任務：甲型駆逐艦【夕雲型/陽炎型】を2隻以上配備した第一艦隊で演習で3回「勝利」、<br>その後、同艦隊を南西諸島海域に投入。各出撃で得られた戦訓を艦隊型駆逐艦戦力整備に活用せよ！',
    reward_fuel: 0,
    reward_ammo: 350,
    reward_steel: 0,
    reward_bauxite: 350,
  ...
  },
  {
    ...
    name: '給糧艦「伊良湖」の支援',
    detail:
      '伊良湖支援任務：軽巡を2隻以上配備した第一艦隊で本日中に演習で3回「勝利」、その後、<br>第一艦隊旗艦に戦闘糧食を二つ装備せよ！　※任務達成後、同戦闘糧食は消費します',
    reward_fuel: 100,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「第二一駆」、猛特訓！',
    detail:
      '駆逐隊演習任務：精鋭「第二一駆逐隊」3隻を含む艦隊を編成。作戦に先立ち、猛特訓を開始する！<br>同艦隊で、本日中に演習で4回勝利せよ！',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '海防艦、演習始め！',
    detail:
      '海防艦演習任務：海防艦を旗艦に配備し、随伴艦に駆逐艦2隻以上を配した演習艦隊を編成。本演習艦隊で、本日中に演習で2回以上勝利せよ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '最精鋭甲型駆逐艦、特訓始め！',
    detail:
      '甲型駆逐隊演習任務：練度70以上の甲型駆逐艦【陽炎型/夕雲型】駆逐艦4隻で編成される駆逐隊。この精鋭駆逐隊を含む艦隊を編成。演習を開始する！同艦隊で本日中に演習にて4回以上勝利せよ！',
    reward_fuel: 400,
    reward_ammo: 0,
    reward_steel: 400,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '改夕雲型、演習始め！',
    detail:
      '改夕雲型演習任務：改夕雲型駆逐艦「夕雲改二」「長波改二」の精鋭駆逐艦2隻を含む艦隊を編成。改夕雲型駆逐隊の慣熟演習を開始する！同艦隊で本日中に演習にて4回以上勝利せよ！',
    reward_fuel: 400,
    reward_ammo: 400,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精強「十七駆」、猛特訓！',
    detail:
      '駆逐隊演習任務：精強「第十七駆逐隊」4隻を含む艦隊を編成。新改装精強駆逐隊による猛特訓を開始する！同艦隊で、本日中に演習で4回以上勝利せよ！',
    reward_fuel: 170,
    reward_ammo: 170,
    reward_steel: 170,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '空母機動部隊、演習始め！',
    detail:
      '空母機動部隊演習任務：航空母艦旗艦他1隻計2隻以上及び駆逐艦2隻を含む空母機動部隊を編成。 機動部隊各艦の練度向上を図る！同艦隊で、本日中に演習で4回以上勝利せよ！',
    reward_fuel: 0,
    reward_ammo: 400,
    reward_steel: 0,
    reward_bauxite: 400,
  ...
  },
  {
    ...
    name: '六周年記念演習',
    detail:
      '六周年記念演習：軽巡クラス1隻と駆逐艦または海防艦計3隻以上を含む6隻編成の特務艦隊を編成。同艦隊による演習で本日中に【S判定】以上4回勝利せよ！',
    reward_fuel: 600,
    reward_ammo: 600,
    reward_steel: 600,
    reward_bauxite: 600,
  ...
  },
  {
    ...
    name: '新しき盾',
    detail:
      '「新しき盾」演習任務：重巡「摩耶」及び重巡「羽黒」を擁する艦隊による演習「新しき盾」を実施する。本「新しき盾」演習において、本日中に【S判定】勝利3回以上達成せよ！',
    reward_fuel: 0,
    reward_ammo: 179,
    reward_steel: 0,
    reward_bauxite: 180,
  ...
  },
  {
    ...
    name: '「十八駆」演習！',
    detail:
      '駆逐艦演習任務：第十八駆逐艦『霞』『霰』『陽炎』『不知火』の4隻を含む演習艦隊を編成。同艦隊で本日中に演習で『S判定』勝利3回以上を達成せよ！精鋭十八駆に落ち度など無し！',
    reward_fuel: 180,
    reward_ammo: 180,
    reward_steel: 180,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '睦月型集合！演習始め！',
    detail:
      '睦月型演習任務：睦月型駆逐艦4隻による駆逐隊を含む演習艦隊を編成。同艦隊で本日中に演習にて4回以上勝利せよ！睦月型、がんばるにゃしぃ！',
    reward_fuel: 200,
    reward_ammo: 200,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「十九駆」演習！',
    detail:
      '駆逐艦演習任務：第十九駆逐隊「磯波」「浦波」「綾波」「敷波」の4隻を含む演習艦隊を編成。<br>同艦隊で本日中に演習で【S判定】勝利3回以上を達成せよ！精鋭十九駆、じゃ、見ててよね！',
    reward_fuel: 190,
    reward_ammo: 190,
    reward_steel: 190,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    detail:
      '鉄鋼5,000及びボーキサイト1,500を準備して、潜水艦派遣作戦により<br>噴式エンジン技術の導入に努めよ！※任務達成後、準備した資源は消費します。',
    reward_fuel: 100,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    name: '海上護衛総隊、遠征開始！',
    detail:
      '遠征任務：遠征任務「対潜警戒任務」「海上護衛任務」「タンカー護衛任務」を実施、<br>軽巡、駆逐艦、海防艦などから編成された護衛艦隊で各遠征を成功させよ！',
    reward_fuel: 700,
    reward_ammo: 700,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '海上通商航路の警戒を厳とせよ！',
    detail:
      '遠征任務：遠征任務「警備任務」「対潜警戒任務」「海上護衛任務」「強行偵察任務」<br>を実施し、敵の通商破壊部隊を制圧、海上通商航路の安全を確保せよ！',
    reward_fuel: 800,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '遠征補給支援体制の強化：鋼材800を用意し、遠征任務「兵站強化任務」を実施。<br>同遠征任務を成功させ、艦隊遠征時における「補給」支援体制の拡充に努めよ！',
    reward_fuel: 200,
    reward_ammo: 200,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '近海に侵入する敵潜を制圧せよ！',
    detail:
      '敵潜制圧任務：遠征任務「対潜警戒任務」「海峡警備行動」「長時間対潜警戒」を<br>それぞれ複数回実施し、近海に潜り込む敵潜部隊を制圧、我が領海から叩き出せ！',
    reward_fuel: 0,
    reward_ammo: 1000,
    reward_steel: 0,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    name: '「捷一号作戦」、発動準備！',
    detail:
      '捷一号作戦準備任務：遠征任務「警備任務」「兵站強化任務」及び「南西方面航空偵察作戦」<br>を実施。これを無事完遂し、南西方面での作戦準備にあたれ！',
    reward_fuel: 0,
    reward_ammo: 600,
    reward_steel: 0,
    reward_bauxite: 600,
  ...
  },
  {
    ...
    name: '「海防艦」、進発せよ！',
    detail:
      '海上護衛任務：遠征任務「兵站強化任務」「海峡警備行動」「海上護衛任務」「タンカー護衛任務」を海防艦、駆逐艦などを主軸とした護衛艦隊で実施せよ！',
    reward_fuel: 800,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 600,
  ...
  },
  {
    ...
    name: '特設護衛船団司令部、活動開始！',
    detail:
      '海上護衛任務：遠征任務「警備任務」「海上護衛任務」「兵站強化任務」「海峡警備行動」<br>「タンカー護衛任務」の各任務を、海防艦・駆逐艦などを主軸とした護衛艦艇で実施せよ！',
    reward_fuel: 1000,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 500,
  ...
  },
  {
    ...
    name: '一航戦精鋭「流星改」隊の編成',
    detail:
      '一航戦任務：旗艦「赤城改二（改二戊）」第一装備スロに「流星改（一航戦）」※連度maxを搭載し、「流星改」×4「彩雲」×1「九七艦攻」×2廃棄、弾薬×2800、ボーキ9000、熟練搭乗員×2を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '陸戦用装備の艦載運用研究',
    detail:
      '第一艦隊旗艦軽巡級の第一装備スロに「7.7mm機銃」装備。「25mm単装機銃」×2、「ドラム缶(輸送用)」×2、「12cm30連装噴進砲」×1を廃棄。弾薬1,700、開発資材×30、高速建造材×10を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「熟練搭乗員」養成',
    detail:
      '勲章x2消費：「鳳翔」秘書艦に練度max及び改修max「九六式艦戦」を搭載、熟練搭乗員を養成せよ！<br>(任務達成後、部隊は消滅します)',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    name: '新型魚雷兵装の開発',
    detail:
      '勲章x2消費：「島風」秘書艦に改修max「61cm五連装(酸素)魚雷」と<br>改修max「61cm三連装(酸素)魚雷」を装備！(任務達成後、各装備は消滅します)',
    reward_fuel: 0,
    reward_ammo: 600,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「陸攻」隊の増勢',
    detail:
      '「基地航空隊」開設に向け、「陸攻」の追加調達を行う。「7.7mm機銃」及び<br>「九九式艦爆」を各二つずつ準備せよ！(任務達成後、同装備は消滅します)',
    reward_fuel: 0,
    reward_ammo: 200,
    reward_steel: 0,
    reward_bauxite: 200,
  ...
  },
  {
    ...
    name: '主力「陸攻」の調達',
    detail:
      '主力陸上攻撃機「一式陸攻」の新規調達を行う。「零式艦戦21型」を二つ「工廠」で廃棄し、<br>「九六式陸攻」一つと「九七式艦攻」二つを準備せよ！(任務達成後、用意した必要装備は消滅します)',
    reward_fuel: 250,
    reward_ammo: 250,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「一式陸攻」性能向上型の調達',
    detail:
      '「一式陸攻」性能向上型の配備を行う。「一式陸攻」一つと「天山」二つを準備せよ！<br>(任務達成後、用意した必要装備は消滅します/「一式陸攻」の熟練度は継承されます)',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    name: '「洋上補給」物資の調達',
    detail:
      '「三式弾」一つを廃棄し、燃料750及び弾薬750と「ドラム缶(輸送用)」二つと「九一式徹甲弾」一つを<br>用意せよ！※任務達成後、用意した資源及び必要装備(徹甲弾は改修値の低いもの優先)は消滅します。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「特注家具」の調達',
    detail:
      '「25mm単装機銃」一つを廃棄、家具コイン5,000と「25mm連装機銃」及び「25mm三連装機銃」を各<br>二つ準備せよ！　※任務達成後、用意した家具コイン及び必要装備(改修値の低いもの優先)は消滅します。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    name: '中部海域「基地航空隊」展開！',
    detail:
      '「ドラム缶(輸送用)」二つを廃棄、燃料1200及びボーキサイト3000、さらに「設営隊」一つを準備せよ！<br>※任務達成後、用意した資源及び「設営隊」は消滅します。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「特注家具」の調達',
    detail:
      '「12.7cm連装高角砲」二つを廃棄し、家具コイン5,000と「14cm単装砲」及び「15.2cm単装砲」を各二つずつ準備せよ！　※任務達成後、用意した家具コイン及び必要装備(低改修を優先)は消費します。',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '新機軸偵察機の開発',
    detail:
      '新機軸の偵察機の調達を行う。「零式水上偵察機」を二つ「工廠」で廃棄し、<br>「一式陸攻」一つと「彩雲」二つを準備せよ！(任務達成後、用意した必要装備は消費します)',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    name: 'ネ式エンジンの増産',
    detail:
      '噴式航空機生産のため、ネ式エンジンの増産を行う。「零式艦戦52型」三つを「工廠」で廃棄し、「流星」「烈風」各二つと鉄鋼8,000を準備せよ！※任務達成後、用意した必要装備と資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「特注家具」の調達',
    detail:
      '主砲「12.7cm連装砲」を二つ廃棄、家具コイン5,000と「7.7mm機銃」及び「九六式艦戦」各二つずつ<br>準備せよ！　※任務達成後、用意した家具コイン及び必要装備(低改修値のもの優先)は消費します。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    name: '工廠稼働！次期作戦準備！',
    detail:
      '「14㎝単装砲」x6廢棄、家具コイン6000と「35.6㎝連装砲」「九六式艦戦」各三つを準備せよ！※任務達成後、用意した家具コイン及び必要装備（低改修値のもの優先）は消費します。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 600,
    reward_bauxite: 600,
  ...
  },
  {
    ...
    name: '六三一空「晴嵐」隊の編成',
    detail:
      '秘書艦に「伊401」または「伊14」または「伊13」を配備。「晴嵐」を一番スロットに搭載。「瑞雲(六三一空)」を二番スロットに搭載。「晴嵐(六三一空)」を新編せよ！　※任務達成後瑞雲は消滅します。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '潜水艦武装の強化',
    detail:
      '「61cm三連装魚雷」を四つ廃棄、開発資材x120と「61cm四連装(酸素)魚雷」「九三式水中聴音機」各三つを準備せよ！　※任務達成後、用意した開発資材及び必要装備(低改修値のもの優先)は消費します。',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「水戦」隊の新編成',
    detail:
      '精鋭飛行隊の新編成：練度max及び改修maxの「二式水戦改」を一番スロットに搭載した秘書艦で、<br>「零式艦戦21型」x2「瑞雲」x2を廃棄！　※新飛行隊を編成する「熟練搭乗員」が必要です。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 50,
  ...
  },
  {
    ...
    name: '精鋭「水戦」隊の増勢',
    detail:
      '精鋭飛行隊の増勢：練度max及び改修maxの「二式水戦改」を一番スロットに搭載した秘書艦で、<br>「零式艦戦21型」x2「瑞雲」x2を廃棄！　※新飛行隊を編成する「熟練搭乗員」が必要です。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 50,
  ...
  },
  {
    ...
    name: '新型砲墳兵装、戦力化開始！',
    detail:
      '工廠任務：新型砲墳兵装の開発及び同戦力化を開始する。「副砲」系装備x10を廃棄、<br>鉄鋼6,000を準備せよ！　※任務達成後、準備した資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 400,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '新型艤装の開発研究',
    detail:
      '工廠任務：新型艤装の開発研究を実施する。「中口径主砲」系装備x10を廃棄、鉄鋼12,000を準備せよ！<br>※任務達成後、準備した資源は消費します。「勲章」と「新型砲墳兵装資材」の獲得選択が可能です。',
    reward_fuel: 0,
    reward_ammo: 500,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '新型艤装の継続研究',
    detail:
      '工廠任務：新型艤装の開発を継続実施する。「大口径主砲」系装備x10を廃棄、鉄鋼18,000を準備せよ！<br>※任務達成後、準備した資源は消費します。「勲章」と「新型砲熕兵装資材」の獲得選択が可能です。',
    reward_fuel: 0,
    reward_ammo: 600,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '電探技術の射撃装置への活用',
    detail:
      '工廠任務：電探技術の射撃装置への活用を研究する。「電探」系装備x10を廃棄、弾薬及び鉄鋼を各8,000<br>準備せよ！※任務達成後、準備した資源は消費します。「勲章」と「兵装資材」の獲得選択が可能です。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    name: '民生産業への協力',
    detail:
      '工廠任務：軍需物資を放出し、民生産業に協力する。「小口径主砲」系装備x16を廃棄、燃料12,000を<br>準備せよ！※任務達成後、準備した資源は消費します。「勲章」と「兵装資材」の獲得選択が可能です。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 600,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「瑞雲」隊の編成',
    detail:
      '秘書艦「日向改」の四番スロットに改修max「瑞雲(六三四空)」を搭載して、ドラム缶(輸送用)x2を廃棄。<br>さらに「九九式艦爆」x2「瑞雲」x2を用意せよ！　※新飛行隊を編成する「熟練搭乗員」が必要です。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    name: '民生産業への協力を継続せよ！',
    detail:
      '工廠任務：軍需物資を放出し、民生産業への協力を継続する。「機銃」系装備x10を廃棄、鉄鋼15,000を<br>準備せよ！※任務達成後、準備した資源は消費します。「特注家具職人」と「勲章」の獲得選択が可能。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    name: '新型戦闘糧食の試作',
    detail:
      '料理任務：手軽に食事をとることができて、なおかつ美味しく腹にがっつりたまる新型の戦闘糧食を<br>開発する。「戦闘糧食」x2と燃料800及びボーキサイト150を用意せよ！油入れ送気開始！調理始め！',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '夜戦型艦上戦闘機の開発',
    detail:
      '練度&改修maxの「F6F-3」を秘書艦一番スロットに搭載、 「13号対空電探」x2 「22号対水上電探」x2<br>を廃棄、開発資材x30、改修資材x6、ボーキサイト5,000、「新型航空兵装資材」x1を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '夜戦型艦上戦闘機の性能強化',
    detail:
      '練度&改修maxの「F6F-5」を秘書艦一番スロットに搭載、 「13号対空電探」x2 「22号対水上電探」x2<br>を廃棄、開発資材x40、改修資材x8、ボーキサイト6,000、「新型航空兵装資材」x1を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '夜間作戦型艦上攻撃機の開発',
    detail:
      '「TBF」を秘書艦一番スロットに搭載、「13号対空電探」x2「22号対水上電探」x2廃棄、開発資材x40<br>改修資材x10、弾薬5,000、ボーキサイト8,000、「新型航空兵装資材」x1、「熟練搭乗員」を用意せよ！',
    reward_fuel: 100,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「遊撃部隊」艦隊司令部の創設',
    detail:
      '遊撃部隊任務：「遊撃部隊 艦隊司令部」を創設する。「艦隊司令部施設」を秘書艦一番スロットに搭載、 <br>電探系装備x3を廃棄、開発資材x10、鋼材x2,000、そして「戦闘詳報」x2を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 300,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '工廠環境の整備',
    detail:
      '工廠整備任務：工廠環境の重整備を実施する。「機銃」系装備x3を廃棄、鋼材300を準備せよ！<br>※任務達成後、準備した資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '運用装備の統合整備',
    detail:
      '運用装備統合任務：装備の統合整備を実施する。「艦上戦闘機」系装備x6、「機銃」系装備x4を廃棄、<br>ボーキサイト800を準備(本任務は時局により更新されます)。　※任務達成後、準備資源を消費します。',
    reward_fuel: 200,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '装備開発力の集中整備',
    detail:
      '工廠環境の集中整備を実施する！「中口径主砲」系装備x3、「副砲」系装備x3、「ドラム缶(輸送用)」x1<br>を廃棄、鋼材2,400を準備せよ！　※任務達成後、準備した資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 200,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '継戦支援能力の整備',
    detail:
      '艦娘の継戦支援体制の整備強化を実施する！「大口径主砲」系装備x4、「水上偵察機」系装備x2、<br>「魚雷」系装備x3を廃棄、鋼材3,600を準備せよ！　※任務達成後、準備した資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 500,
    reward_steel: 0,
    reward_bauxite: 150,
  ...
  },
  {
    ...
    name: '主力艦上戦闘機の更新',
    detail:
      '艦上戦闘機「九六式艦戦」x3、「零式艦戦21型」x5を廃棄。秘書艦の一番及び二番装備スロットに<br>「零式艦戦52型」を装備。ボーキサイト4,000を準備せよ。※任務達成後、準備資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '対空兵装の拡充',
    detail:
      '対空兵装の整備拡充を実施する！「中口径主砲」系装備x6、「副砲」系装備x3を廃棄、<br>ボーキサイト900を準備せよ！　※任務達成後、準備した資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '対空兵装の整備拡充',
    detail:
      '対空兵装の整備拡充を継続実施する!「機銃」系装備x4、「電探」系装備x4を廃棄、ボーキサイト1,500を準備せよ!※任務達成後、準備した資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 200,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「海防艦」整備計画',
    detail:
      '大型艦兵装を整理削減、警備及び海上護衛用小艦艇「海防艦」を整備する。「中口径主砲」x4、「大口径主砲」x4を破棄し、燃料500を準備せよ！※任務達成後、準備した資材は消費します。',
    reward_fuel: 200,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「航空戦艦」彗星隊の編成',
    detail:
      '精鋭彗星隊編成：旗艦「伊勢改二」第三スロに「彗星二二型(六三四空)」搭載、熟練搭載員、開発資材×30、新型航空兵装資材を用意、「九九艦爆」「彗星」各×3廃棄、ボーキサイト一定量確保せよ！',
    reward_fuel: 0,
    reward_ammo: 634,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '駆逐艦主砲兵装の戦時改修',
    detail:
      '旗艦特型駆逐艦の第一スロに「12.7cm連装砲A型改二」改修maxを装備、 「10cm連装高角砲」x4 「94式高射装置」x1を廃棄、開発資材x30、鋼材900、新型砲熕兵装資材x1を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 200,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '戦時改修A型高角砲の量産',
    detail:
      '旗艦特型駆逐艦の第一スロに「12.7cm連装砲A型改二」改修maxを装備、「10cm連装高角砲」x4、「94式高射装置」x1を廃棄、開発資材x30、鋼材900、新型砲熕兵装資材x1を再び準備せよ！',
    reward_fuel: 0,
    reward_ammo: 200,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '旗艦「夕立改二」または「時雨改二」第一スロに「12.7cm連装砲B型改二」改修max装備、「10cm連装高角砲」×5及び「94式高射装置」×1廃棄、開発資材×50、鋼材1200、新型砲熕兵装資材×1を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 220,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '航空戦力の強化',
    detail:
      '航空戦力強化任務：「艦戦」「艦爆」「艦攻」「水偵」を各3装備ずつ破棄、さらに熟練搭乗員x1、及びボーキサイト1,800を準備せよ！（任務達成後、熟練搭乗員x1及びボーキサイト1,800は消滅します）',
    reward_fuel: 100,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '戦闘機隊戦力の拡充',
    detail:
      '戦闘機拡充任務：「艦戦」「水偵」各×4、「艦偵」×2装備を廃棄、熟練搭乗員×1、新型航空兵装資材×1、ボーキサイト3,000を準備せよ！（任務達成後、準備した資源・熟練搭乗員・新型航空兵装資材は消費）',
    reward_fuel: 0,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '基地航空隊戦力の拡充',
    detail:
      '基地航空隊拡充任務：「艦戦」「艦爆」「艦攻」各×4装備を廃棄、熟練搭乗員×1、新型航空兵装資材×2、ボーキサイト4,800を準備せよ！（任務達成後、準備した資源・熟練搭乗員・新型航空兵装資材は消費）',
    reward_fuel: 0,
    reward_ammo: 200,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '提督室のリフォーム',
    detail:
      '提督室のリフォームを実施する！まずは装備の整理から！「中口径主砲」系装備x4、「副砲」系装備x4、「機銃」系装備x4を廃棄、ボーキサイト1,600を準備せよ！',
    reward_fuel: 200,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '水上艦艇装備工廠の整備',
    detail:
      '水上艦艇装備工廠の整備を実施する！「小口径主砲」系装備x5、「大口径主砲」系装備x5、「水偵」系装備x5を廃棄、鋼材3,000を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    name: '回転翼機の開発',
    detail:
      '回転翼機装備の研究開発を実施する。「水偵」系装備x4、「艦戦」系装備x3、「艦攻」系装備x2を廃棄、ボーキサイト3,000、開発資材x20を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '新型航空艤装の研究',
    detail:
      '艦艇の航空運用能力を高める新型航空艤装の研究を行う。「瑞雲」x4、「彗星」x4、「流星」x2を廃棄、鋼材8,500、ボーキサイト4,000、開発資材x60を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「彗星」艦爆の新運用研究',
    detail:
      '三号爆弾運用：旗艦「伊勢改二」または「日向改二」第一スロに「彗星一二型甲」搭載、 「彗星」x4、「九九式艦爆」x3、「瑞雲」x2廃棄、弾薬x2,500、ボーキ5,000、新型航空兵装資材x1を準備せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '最精鋭「瑞雲」隊の編成',
    detail:
      '旗艦「伊勢改二」「日向改二」 第一ス口に「瑞雲改二(六三四空)」※改修max。「瑞雲」x6「彗星」x3、「試製烈風 後期型」x1廃棄、弾薬2,000、ボ一キ8,000、新型航空兵装資材x1、熟練搭乗員x2を準備！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '航空艤装の近代化改修',
    detail:
      '鉄鋼5,500及びボーキサイト2,500を準備して、任意の正規空母の近代化改修を<br>[航空母艦]x5隻同時使用により2回成功させよ！※任務達成後、準備した資源は消費します。',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '軽巡級旗艦と駆逐艦4隻の水雷戦隊を基幹とした艦隊を編成、<br>南西諸島防衛線に反復出撃し、同海域の制海権確保に努めよ！',
    reward_fuel: 0,
    reward_ammo: 350,
    reward_steel: 0,
    reward_bauxite: 350,
  ...
  },
  {
    ...
    detail:
      '軽空母旗艦と駆逐艦3隻を基幹とした護衛艦隊を編成、<br>製油所地帯沿岸に展開し、同海域の哨戒を実施、同海域の安全を確保せよ！',
    reward_fuel: 600,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '水雷戦隊を基幹とした有力な艦隊で南西諸島海域バシー島沖及び東部オリョール海を哨戒、<br>同海域に遊弋する敵艦隊を捕捉、これを撃滅せよ！',
    reward_fuel: 600,
    reward_ammo: 600,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「第十九駆逐隊」出撃せよ！',
    detail:
      '特型駆逐艦4隻による「第十九駆逐隊」を鎮守府近海に展開！<br>鎮守府正面対潜哨戒を実施し、跳梁する敵潜部隊の制圧に努めよ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 300,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '「第十九駆逐隊」を含む有力な艦隊を編成し、南西諸島海域沖ノ島沖に展開！<br>同方面に遊弋する敵主力を捕捉、これを撃破せよ！',
    reward_fuel: 600,
    reward_ammo: 600,
    reward_steel: 0,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    name: '飛行場設営の準備を実施せよ！',
    detail:
      '中部海域における航空偵察「K作戦」を再度実施、さらに同方面に遊弋する敵艦隊を撃滅し、<br>中部海域における飛行場設営の準備を実施せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '有力な艦隊をカムラン半島に投入、同方面に出没する敵艦隊を捕捉、これを撃滅せよ！<br>そして、夜を照らす「灯り」を入手せよ！　ある季節は夜戦以外にも使い道があるようだ！',
    reward_fuel: 100,
    reward_ammo: 100,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '南西諸島防衛線を増強せよ！',
    detail:
      '水上機母艦または航空巡洋艦を旗艦とする有力な艦隊を南西諸島防衛線に投入、<br>水上機戦力によって同防衛線を強化、同方面の敵艦隊を撃滅せよ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「第十六戦隊」突入せよ！',
    detail:
      '再編成を完了した精鋭「第十六戦隊」を南西諸島海域沖ノ島沖に展開、<br>同方面に遊弋する敵主力を捕捉、これを撃破せよ！',
    reward_fuel: 600,
    reward_ammo: 600,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '輸送作戦を成功させ、帰還せよ！',
    detail:
      '「鬼怒改二」を旗艦、僚艦に「浦波改」他駆逐艦3隻の計5隻の艦隊で<br>バシー島沖における柳輸送作戦を実施、同輸送作戦を完全成功させ、帰還せよ！',
    reward_fuel: 1000,
    reward_ammo: 0,
    reward_steel: 1000,
    reward_bauxite: 3000,
  ...
  },
  {
    ...
    name: '重巡戦隊、抜錨せよ！',
    detail:
      '重巡4隻を基幹戦力とした重巡旗艦の艦隊を南西諸島海域東部オリョール海に展開し、<br>同海域の敵艦隊を撃滅、制海権を確保せよ！',
    reward_fuel: 400,
    reward_ammo: 400,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '戦艦戦隊、出撃せよ！',
    detail:
      '戦艦2隻を中核戦力とする戦艦旗艦の艦隊を北方海域アルフォンシーノ方面に進出させ、<br>同海域の敵艦隊を撃滅、北方海域の制海権確保に努めよ！',
    reward_fuel: 0,
    reward_ammo: 800,
    reward_steel: 0,
    reward_bauxite: 200,
  ...
  },
  {
    ...
    name: '主力戦艦戦隊、抜錨せよ！',
    detail:
      '戦艦または航空戦艦2隻以上からなる強力な戦艦戦隊を中核とした艦隊を沖ノ島海域前面に展開、<br>侵攻する敵艦隊を捕捉、これを撃滅せよ！',
    reward_fuel: 0,
    reward_ammo: 800,
    reward_steel: 400,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「第八駆逐隊」突入せよ！',
    detail:
      '「荒潮改二」を旗艦とし、僚艦に「第八駆逐隊」から1隻を配備した精鋭第1艦隊で<br>サーモン海域北方に突入、同方面に接近する有力な敵艦隊を捕捉、同方面の敵戦力の漸減に努めよ！',
    reward_fuel: 800,
    reward_ammo: 800,
    reward_steel: 0,
    reward_bauxite: 800,
  ...
  },
  {
    ...
    detail:
      '潜水艦を旗艦とし、4隻以上の有力な潜水艦を配備した第一艦隊、精鋭潜水艦隊で<br>中部海域哨戒線に進出、回航中の敵空母を捕捉、これを襲撃せよ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 300,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '第一艦隊旗艦に「Zara due」を配備、同艦隊で南方サブ島沖海域へ突入！同方面の敵艦隊群を突破し、鉄底海峡に展開する敵戦力を撃破せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 700,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '軽巡を旗艦とした艦隊を編成し、南西諸島防衛線、バシー島沖及び<br>東部オリョール海に展開、同海域に遊弋する敵艦隊を撃破せよ！',
    reward_fuel: 300,
    reward_ammo: 0,
    reward_steel: 300,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    name: '洋上航空戦力を拡充せよ！',
    detail:
      '航空母艦、または水上機母艦を旗艦とした有力な艦隊を編成、北方AL海域、<br>西方海域カスガダマ沖 、中部海域MS諸島沖に展開し、各海域の敵艦隊を撃滅せよ！',
    reward_fuel: 500,
    reward_ammo: 500,
    reward_steel: 0,
    reward_bauxite: 1000,
  ...
  },
  {
    ...
    name: '改装航空巡洋艦、出撃！',
    detail:
      '改装航空巡洋艦「鈴谷改二」を旗艦とした精強な艦隊を編成、同艦隊を南方海域に展開、<br>南方海域前面、及びサブ島沖海域に遊弋する敵艦隊群を捕捉、これを撃破せよ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 300,
    reward_bauxite: 700,
  ...
  },
  {
    ...
    detail:
      '改装航空母艦「鈴谷航改二」を旗艦とした精強な機動部隊を編成、同艦隊を中部海域に進出。<br>MS諸島沖、KW環礁沖海域に展開し、同海域の敵機動部隊を捕捉、これを撃滅せよ！',
    reward_fuel: 0,
    reward_ammo: 1000,
    reward_steel: 0,
    reward_bauxite: 1000,
  ...
  },
  {
    ...
    name: '鎮守府海域警戒を厳とせよ！',
    detail:
      '巡洋艦クラスを旗艦に配備、2隻以上の駆逐艦を擁する警戒艦隊を編成せよ。同警戒艦隊を以て、<br>鎮守府海域(南西諸島/製油所地帯沿岸/南西諸島防衛線/鎮守府近海)の警戒任務にあたれ！',
    reward_fuel: 400,
    reward_ammo: 400,
    reward_steel: 400,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '戦果拡張作戦：我が第一艦隊に精鋭艦艇を集中配備、同精鋭艦隊を以て、南西諸島の沖ノ島海域、<br>中部海域哨戒線、グアノ環礁沖の敵艦隊を撃破、中部北海域ピーコック島の敵戦力を破砕殲滅せよ！',
    reward_fuel: 0,
    reward_ammo: 2000,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '海上護衛体制の強化に努めよ！',
    detail:
      '海上護衛作戦：駆逐艦または海防艦3隻以上を含む護衛艦隊を編成し、鎮守府海域の製油所地帯沿岸、<br>南西諸島防衛線、鎮守府近海、鎮守府近海航路にそれぞれ展開、各海域における作戦を成功させよ！',
    reward_fuel: 400,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 400,
  ...
  },
  {
    ...
    name: '新編「第一戦隊」、抜錨せよ！',
    detail:
      '新編「第一戦隊」出撃任務：戦艦「長門改二」を旗艦、二番艦に「陸奥改」を配備した第一艦隊で出撃！<br>カレー洋リランカ島沖、サーモン海域北方に展開し、同海域の敵艦隊主力を捕捉、これを撃滅せよ！',
    reward_fuel: 0,
    reward_ammo: 880,
    reward_steel: 880,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '増強海上護衛総隊、抜錨せよ！',
    detail:
      '出撃任務：軽巡1隻以上、駆逐艦または海防艦2隻以上、さらに航空巡洋艦または軽空母で増強した<br>第一護衛艦隊を第一艦隊に編成、南西諸島海域の各海域に展開、敵艦隊を撃破、各作戦を成功させよ！',
    reward_fuel: 700,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '新編「第七戦隊」、出撃せよ！',
    detail:
      '出撃任務：新編「第七戦隊」を出撃！　カレー洋リランカ島沖「深海東洋艦隊漸減作戦」、<br>MS諸島沖「MS諸島防衛戦」において、敵艦隊主力を捕捉、これを撃滅せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 1000,
    reward_bauxite: 500,
  ...
  },
  {
    ...
    name: '精鋭「第四航空戦隊」、抜錨せよ！',
    detail:
      '精鋭「第四航空戦隊」出撃任務：精鋭航空戦艦を主戦力に再編された「第四航空戦隊」、抜錨せよ！<br>沖ノ島沖戦闘哨戒及び北方AL海域戦闘哨戒を実施、同方面の敵艦隊主力を捕捉、これを撃破せよ！',
    reward_fuel: 500,
    reward_ammo: 0,
    reward_steel: 500,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '旗艦「由良」、抜錨！',
    detail:
      '出撃任務：旗艦に「由良改二」、随伴艦に二駆「村雨」「夕立」「春雨」「五月雨」及び「秋月」から<br>二隻以上を配備した第一艦隊を展開、東部オリョール海及び南方海域前面の敵戦力を撃滅せよ！',
    reward_fuel: 400,
    reward_ammo: 400,
    reward_steel: 0,
    reward_bauxite: 400,
  ...
  },
  {
    ...
    name: '強行輸送艦隊、抜錨！',
    detail:
      '航路護衛任務：航空戦艦(または補給艦でも可)2隻を中核とした艦隊で、鎮守府近海航路における<br>輸送船団護衛作戦を実施。同輸送護衛作戦を2回成功させよ！',
    reward_fuel: 1000,
    reward_ammo: 400,
    reward_steel: 400,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '前線の航空偵察を実施せよ！',
    detail:
      '偵察任務：水上機母艦1隻と軽巡2隻を中核とした偵察艦隊を、中部海域グアノ環礁沖海域に展開、<br>航空偵察作戦「K作戦」を反復実施せよ！さらに同方面の敵艦隊を捕捉、敵戦力の撃破に努めよ！',
    reward_fuel: 0,
    reward_ammo: 800,
    reward_steel: 0,
    reward_bauxite: 1000,
  ...
  },
  {
    ...
    name: '精鋭「第二二駆逐隊」出撃せよ！',
    detail:
      '出撃任務：再編した精鋭「第二二駆逐隊」を含む精強な水雷戦隊で北方海域キス島沖に出撃、<br>キス島撤退作戦を完全成功させよ！',
    reward_fuel: 0,
    reward_ammo: 700,
    reward_steel: 0,
    reward_bauxite: 100,
  ...
  },
  {
    ...
    name: '精強大型航空母艦、抜錨！',
    detail:
      '出撃任務：「Saratoga Mk.II」または同「Mod.2」を旗艦とした「任務部隊」で、南方海域サーモン海域<br>北方及び中部海域MS諸島沖に展開、同海域敵戦力を捕捉撃滅、「MS諸島防衛戦」を成功させよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 700,
    reward_bauxite: 700,
  ...
  },
  {
    ...
    name: '夜間作戦空母、前線に出撃せよ！',
    detail:
      '出撃任務：「Saratoga Mk.II」を旗艦とした第一艦隊を KW環礁沖海域に展開、敵機動部隊を迎撃！<br>「空母機動部隊迎撃戦」を見事成功させよ！　夜戦作戦空母、抜錨！　前線に出撃せよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 1000,
  ...
  },
  {
    ...
    name: '補給線の安全を確保せよ！',
    detail:
      '軽巡クラスの艦隊旗艦と2隻以上の駆逐艦または海防艦を中核とした警戒艦隊を編成、同艦隊で<br>鎮守府海域(製油所地帯沿岸/南西諸島防衛線/鎮守府近海)の警戒と補給線安全確保にあたれ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「第八駆逐隊」、南西へ！',
    detail:
      '第八駆逐隊任務：「第八駆逐隊」を含む艦隊で、鎮守府海域南西諸島沖、及び南西諸島海域バシー島沖に<br>展開！同海域に跳梁する敵艦隊戦力を捕捉、これを撃滅せよ！',
    reward_fuel: 0,
    reward_ammo: 250,
    reward_steel: 250,
    reward_bauxite: 250,
  ...
  },
  {
    ...
    name: '最精鋭「第八駆逐隊」、全力出撃！',
    detail:
      '第八駆逐隊任務：最精鋭「第八駆逐隊」を中核戦力とした艦隊を編成、北方海域キス島沖、及び<br>南方海域サーモン海域に突入！同海域の敵艦隊を撃滅、第八駆逐隊による完全勝利を刻め！',
    reward_fuel: 800,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '北方海域警備を実施せよ！',
    detail:
      '北方海域警備任務：北方海域の警備を実施する。軽巡を1隻以上含む艦隊で、北方海域モーレイ海、<br>キス島沖、アルフォンシーノ方面に艦隊を展開、北方海域方面の警備と制海権確保に努めよ！',
    reward_fuel: 500,
    reward_ammo: 500,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '北方海域戦闘哨戒を実施せよ！',
    detail:
      '北方海域戦闘哨戒任務：北方AL海域に軽空母と水上機母艦及び軽巡を基幹戦力とした精鋭艦隊を投入。<br>北方戦闘哨戒を反復実施、同方面の敵増援部隊主力を捕捉、これを撃滅し、北方海域戦線を防衛せよ！',
    reward_fuel: 0,
    reward_ammo: 1000,
    reward_steel: 0,
    reward_bauxite: 700,
  ...
  },
  {
    ...
    detail:
      '強行東京急行任務：精鋭「三一駆」第一小隊を護衛戦力とした突入艦隊を編成、南方サーモン海域に投入。<br>鉄底海峡に突入し、同海域に展開する敵艦艇を実力で排除、強行鼠輸送作戦を反復完遂せよ！',
    reward_fuel: 310,
    reward_ammo: 310,
    reward_steel: 0,
    reward_bauxite: 310,
  ...
  },
  {
    ...
    name: '松輸送作戦、開始せよ！',
    detail:
      '防衛ラインの強化のため、艦隊旗艦「龍田改二」または「龍田改」、3隻以上の駆逐艦または海防艦を<br>含む輸送護衛艦隊を編成、南西諸島防衛線及び鎮守府近海航路における作戦を複数回成功させよ！',
    reward_fuel: 200,
    reward_ammo: 200,
    reward_steel: 200,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '「村雨改二」旗艦含む精鋭四水戦(4Sd)より4隻(他主力艦2隻)計6隻の精鋭艦隊を南方海域に展開。<br>南方海域前面、サブ島沖海域、サーモン海域に突入、同南方海域方面の敵艦隊を撃破せよ！',
    reward_fuel: 400,
    reward_ammo: 400,
    reward_steel: 0,
    reward_bauxite: 400,
  ...
  },
  {
    ...
    name: '松輸送作戦、継続実施せよ！',
    detail:
      '「艦隊旗艦に軽巡級または駆逐艦、さらに3隻以上の駆逐艦または海防艦を含む輸送護衛艦隊を編成、<br>防衛ラインの強化のため、南西諸島防衛線及び鎮守府近海航路における作戦を継続的に成功させよ！',
    reward_fuel: 300,
    reward_ammo: 300,
    reward_steel: 0,
    reward_bauxite: 300,
  ...
  },
  {
    ...
    name: '新編「四航戦」、全力出撃！',
    detail:
      '「航空戦艦「伊勢改」「日向改」及び軽巡「大淀改」と1隻以上の駆逐艦を含む新編第四航空戦隊を編成、<br>鎮守府近海航路、沖ノ島沖及び北方AL海域戦闘哨戒、カレー洋リランカ島沖の作戦に投入せよ！',
    reward_fuel: 400,
    reward_ammo: 400,
    reward_steel: 400,
    reward_bauxite: 400,
  ...
  },
  {
    ...
    name: '「十八駆」、北方海域キス島へ！',
    detail:
      '精鋭「第十八駆逐隊」を投入し、北方海域キス島撤退作戦を実施する！同作戦に反復出動し、キス島撤退作戦を完全成功させよ！',
    reward_fuel: 0,
    reward_ammo: 0,
    reward_steel: 480,
    reward_bauxite: 480,
  ...
  },
  {
    ...
    detail:
      '「黒潮改二」「不知火改二」「陽炎改二」のいずれかを旗艦、他2隻の練度75以上の甲型駆逐艦を配備した計6隻艦隊で西方カレー洋、北方キス島沖、南方サブ島沖海域に複数回突入、各作戦を完全成功させよ！',
    reward_fuel: 0,
    reward_ammo: 1000,
    reward_steel: 0,
    reward_bauxite: 500,
  ...
  },
  {
    ...
    detail:
      '旗艦「伊勢改二」随伴駆逐艦2隻の航空戦隊を基幹とする艦隊をKW環礁沖空母機動部隊迎撃戦に投入！同反復出撃によって、同方面に来襲する敵機動部隊を迎撃、完全撃滅せよ！　「伊勢改二」、抜錨！',
    reward_fuel: 634,
    reward_ammo: 0,
    reward_steel: 1000,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精強「十七駆」、北へ、南へ！',
    detail:
      '改装甲型駆逐艦「磯風乙改」「浜風乙改」「浦風丁改」「谷風丁改」4隻の精強「十七駆」を含む艦隊で鎮守府近海、キス島沖、ブルネイ泊地沖、南方海域前面に出撃、敵戦力と交戦、これを撃破せよ！',
    reward_fuel: 1000,
    reward_ammo: 1000,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    detail:
      '空母を含む有力な哨戒艦隊を編成、製油所地帯沿岸、南西諸島防衛戦、南西諸島近海、バシー海峡及び東部オリョール海を戦闘哨戒、各海域の敵艦隊を捕捉撃滅、各海域兵站線の安全を確保せよ！',
    reward_fuel: 600,
    reward_ammo: 0,
    reward_steel: 600,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '航空戦艦戦隊、戦闘哨戒！',
    detail:
      '航空戦艦二隻を中核とする艦隊を編成、同艦隊で南西諸島防衛線、鎮守府近海及び東部オリョール海、タウイタウイ泊地沖に展開。同海域の脅威となる敵艦隊主力を捕捉、これを撃滅せよ！',
    reward_fuel: 600,
    reward_ammo: 600,
    reward_steel: 0,
    reward_bauxite: 600,
  ...
  },
  {
    ...
    detail:
      '改装軽巡「夕張改二」型旗艦を含む第六水雷戦隊４隻以上を擁する艦隊で、鎮守府近海、鎮守府近海航路、さらに南西諸島バシー海峡、北方キス島沖、南西ブルネイ泊地沖の各作戦を、それぞれ完全成功させよ！',
    reward_fuel: 3000,
    reward_ammo: 0,
    reward_steel: 0,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '拡張「六水戦」、最前線へ！',
    detail:
      '軽巡「夕張改二」型の旗艦に随伴第六水雷戦隊駆逐艦２隻以上または「由良改二」を含む艦隊で、南方海域前面、南方サーモン海域、中部北海域ピーコック島沖、中部KW環礁沖海域に展開、敵戦力を撃滅せよ！',
    reward_fuel: 1000,
    reward_ammo: 1000,
    reward_steel: 1000,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '精鋭「十九駆」、躍り出る！',
    detail:
      '改装特II型駆逐艦「綾波改二」及び同「敷波改二」を含む精鋭艦隊を前線に投入、南西諸島海域沖ノ島沖、<br>北方海域全域、西方海域カレー洋リランカ島沖、南方サブ島沖海域に展開、各敵主力を捕捉撃滅せよ！',
    reward_fuel: 1900,
    reward_ammo: 0,
    reward_steel: 1900,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '「海防艦」、海を護る！',
    detail:
      '海防艦3隻を含む5隻以下の海上護衛隊を、鎮守府海域に展開。鎮守府正面海域、南西諸島沖海域、製油所<br>地帯沿岸、鎮守府近海、鎮守府近海航路の各海域の安全確保と対潜掃蕩を図れ！海防艦戦隊、抜錨せよ！',
    reward_fuel: 1200,
    reward_ammo: 600,
    reward_steel: 600,
    reward_bauxite: 0,
  ...
  },
  {
    ...
    name: '再編「第三一駆逐隊」、抜錨せよ！',
    detail:
      '夕雲型駆逐艦「長波」「岸波」「朝霜」、そして「沖波改二」からなる再編第三一駆逐隊を含む艦隊を、製油所地帯沿岸、南西諸島防衛線、鎮守府近海、バシー海峡、東部オリョール海に展開、敵を撃破せよ！',
    reward_fuel: 880,
    reward_ammo: 880,
    reward_steel: 880,
    reward_bauxite: 500,
  ...
  },
  {
    ...
    detail:
      '「比叡改二丙」含む金剛型高速戦艦2隻以上、軽巡級1隻、駆逐艦1隻以上を含む艦隊を南方海域に投入！南方海域前面、珊瑚諸島沖、サブ島沖海域、サーモン海域、同北方の敵艦隊を捕捉、これを撃滅せよ！',
    reward_fuel: 1942,
    reward_ammo: 2020,
    reward_steel: 0,
    reward_bauxite: 0,
