...
for (t = 0; t < ranget.length; t++) {
  ...
  switch (qn) {
    ...
    case 'd1'://zhimg
      ...
      break;
    case 'd2'://zhimg
      zhimg = ["https://pic2.zhimg.com/v2-7fa5e8dbf30474632ce928cd02ece519_r.png", "https://img-blog.csdnimg.cn/20210205144046641.png"]
      break;
    case 'd3':
...
function getimg(zhimg, qn, n) {
  ...
  $.get(zhimg[n % zhimg.length], success, "text").done(function (result) {
    ...
    if (start < 0) {
      console.log(n, qn + ": handle failed:RECORDS not found", zhimg[n % zhimg.length], (result.length / 1024).toFixed(2) + "KB", result.slice(-200));
