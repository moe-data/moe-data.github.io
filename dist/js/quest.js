 -28 2 -88 -38 -88 -10 0 -26 7 -34 16 -9 8 -16 24 -16 34 0 40 60 66 88 38z m461 -29 c12 -16 19 -34 16 -39 -7 -11 -90 -24 -104 -16 -6 4 -4 20 6 44 25 60 44 63 82 11z m-336 -99 c26 -12 47 -25 47 -30 0 -20 -56 -73 -102 -96 -28 -14 -51 -24 -53 -22 -2 2 -8 35 -13 73 -9 66 -9 71 12 88 23 19 41 17 109 -13z m-168 -45 c4 -22 9 -55 12 -72 5 -32 4 -33 -29 -33 -35 0 -128 40 -147 64 -9 11 2 23 49 59 54 40 63 44 85 33 17 -8 26 -22 30 -51z`
}, {
	name: "出击2"
}, {
	name: "其他",
...
const tcache = "tcache"
const birth = periodstart('once', new Date())
const TimezoneOffset = (new Date()).getTimezoneOffset() * 60000
var araboffset = TimezoneOffset + 4 * 60 * 60000
...
let valid = []
let valido = {}
let dawn = periodstart('daily', String(new Date()))
data.forEach(function (e, i) {
	wkid[String(e.game_id)] = e.wiki_id
	wktoi[String(e.wiki_id)] = i
	// gameid[String(e.wiki_id)] = e.game_id
});
data.forEach(function (e, i) {
	e.guess = ifnull(getstat(e.wiki_id), 0)
	// e.star = ifnull(get('star'+e.wiki_id),false)
	// e.del = ifnull(get('del'+e.wiki_id),false)
...
// }
let current = data[0]
let that, those, switches, chartdata, reward, battle
let app={}
...
function datawk(wkid) {
	if (wktoi[wkid] != null && data[wktoi[wkid]]!=null) {
		return data[wktoi[wkid]]
	} else {
		z(wkid + ' is not in data!', wktoi[wkid], data)
...
function setwk(wkid, key, value) {
	if (wktoi[wkid] != null && data[wktoi[wkid]]!=null) {
		data[wktoi[wkid]][key] = value
	} else {
		x(wkid,' is not in data!', wktoi[wkid], data)
		option.title.text = '未找到目标任务：' + wkid
	}
}

function getwk(wkid, key) {
	if (wktoi[wkid] != null && data[wktoi[wkid]]!=null) {
		return data[wktoi[wkid]][key]
	} else {
		x(wkid,' is not in data!', wktoi[wkid], data)
		option.title.text = '未找到目标任务：' + wkid
	}
...
function getstat(wkid) {
	// let history = get('history') || []
	try {
		// let l = history.length
		return valido[wkid][beginutc(wkid, new Date())][0]
	} catch (e) {
		// w(e, wkid, valido[wkid])
		return null
	}
}
...
// 		if(n==data[i].game_id)return data[i].wiki_id;
// 	}
// }
function wkids(arr) {
	if (!arr) return []
...
function initChart(canvas, width, height, dpr) {
	...
	// 			down: that.data.down
	// 		})
	// 		z(params.data, [ex[params.data.wiki_id], ey[params.data.wiki_id]], valido[(params.data.wiki_id)])
...
function initcache(key, def) {
	return ifnull(get(key), def)
}
...
function beginutc(wkid, datestr) {
	let dt = new Date(datestr)
	if (!(dt instanceof Date)) {
		x(wkid, datestr, dt);
		return periodstart('once', new Date()).toISOString()
	}
	if (!getwk(wkid, 'period')) {
		// x(wkid,datawk(wkid))
		return periodstart('once', new Date()).toISOString()
	}
	var utc = periodstart(getwk(wkid, 'period'), dt).toISOString()
...
function periodstart(period, dt) { //返回dt的上一个周期的起讫
	...
	if (period == 'daily') {
		...
		endTime = new Date(nowYear, nowMonth, getMonthDays(nowMonth, nowYear));
	} else if (period == 'seasonal') {
		var quarterStartMonth = 0;
		beginTime = new Date(nowYear, quarterStartMonth, 1);
		var quarterEndMonth = quarterStartMonth + 2;
		endTime = new Date(nowYear, quarterEndMonth, getMonthDays(quarterEndMonth, nowYear));
...
// 	if (data[i].type > 1)
// 		z(beginutc(data[i].wiki_id, new Date()),data[i].period, )
// }
// setTimeout(() => {
// 	update();
// 	var dawn = periodstart('daily', String(new Date()))
// }, dawn + 10000000000);
...
function update() {
	...
	let valid = [];
	(get('history') || []).forEach(function (h) {
		let vali = {}
		vali[beginutc(h[0], h[2])] = [h[1], h[2]]
		valido[h[0]] = vali
		//以后可以设置跳过已遍历的index
	})
	for (let wkid in valido) {
		for (let dt in valido[wkid]) {
			valid.push([wkid, valido[wkid][dt][0], valido[wkid][dt][1]])
			if (dt == beginutc(wkid, new Date()))
				setwk(wkid, 'last', valido[wkid][beginutc(wkid, new Date())])
		}
	}
	z('v: ', valido, valid)
	//sort valid
	...
	valid.forEach(function (v) {
		if (valido[v[0]] != null) {
			let stat = valido[v[0]][beginutc(v[0], new Date())][0]
			if (stat != null)
				affect(v[0], stat)
		}
	})
...
function setchart() {
	...
	if (switches.fb != 0 && switches.fb < those.branches.length - 2) {
		...
		switch (switches.fb) {
			case 0:
				chain = JSON.parse(JSON.stringify(data))
				z(chain)
				break;
	...
	if (chain.length + edge.length > 1950) {
		...
		edge = link.slice(0, 950 - edge.length - chain.length)
	} else {
		option.title.text = ''
	}
	chain.forEach(function (e) {
		...
		if (getstat(e.wiki_id) == e.guess) {
			switch (Number(getstat(e.wiki_id))) {
				case 0:
					s0(e, 1)
					break;
				case 1:
	...
	for (let i = 0; i < chartdata._idList.length; i++) {
		try {
			if (chartdata._itemLayouts[i]) {
				ex[wkid[chartdata._idList[i]]] = parseInt(chartdata._itemLayouts[i][0])
				ey[wkid[chartdata._idList[i]]] = parseInt(chartdata._itemLayouts[i][1])
			}
		} catch (error) {
				...
				for (let i = 0; i < e.reward_other.length; i++) {
					if (e.reward_other[i].name) {
						...
						for (let j = 0; j < e.reward_other.length; j++)
							addreward(e, e.reward_other[i].choices[i]);
					}
				}
			}
		})
...
function addreward(e, r) {
	...
	reward[e.guess][name] = ifnull(reward[e.guess][name], 0)
	reward[e.guess][name] += Number(amount)
}

switches= initcache('switches', {
...
// 		if (d == getstat(this.data.current.wiki_id)) return
// 		// z(d)
// 		// 		z(getstat(this.data.current.wiki_id))
...
// 		this.setData({
// 			current: ifnull(get('current'), data[0])
// 		})
// 	},
// 	onShow() {
// 		console.time('计时器2')
// 	},
// 	onHide() {
// 		set('current', this.data.current)
// 		set('switches', this.data.switches)
// 	},
// 	onUnlad() {
// 		set('current', this.data.current)
// 		set('switches', this.data.switches)
